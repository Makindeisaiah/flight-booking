...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/property-list-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:41 GMT -->
<head>
	  <meta charset="utf-8">
						...
						<div class="row justify-content-center gy-4 gx-xl-4 gx-lg-3 gx-md-4 gx-4">
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
								<div class="pop-touritem">
									<a href="#" class="card rounded-3 m-0">
										<div class="flight-thumb-wrapper">
											<div class="popFlights-item-overHidden">
												<img src="assets/img/property/img-7.jpg" class="img-fluid" alt="">
											</div>
										</div>
										<div class="touritem-middle position-relative p-3">
											<div class="touritem-flexxer">
							...
							<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
								<div class="text-center position-relative mt-3">
									<button class="btn rounded-pill btn-primary" type="button">Load More Properties...</button>
								</div>
							</div>
