...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/compare-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:54 GMT -->
<head>
  <meta charset="utf-8">
					...
					<div class="col-xl-7 col-lg-9 col-md-12">
						...
						<div class="fpc-capstion text-center my-4">
							<div class="fpc-captions">
								<h1 class="xl-heading text-light">Compare Your Hotels</h1>
				...
				<div class="row gx-4 gy-4">
					<div class="col-lg-3 col-md-4 col-sm-12 text-center">
						<div class="comp-property">
							<a href="JavaScript:Void(0);">
								<div class="clp-img">
									<img src="assets/img/hotel/hotel-1.jpg" class="img-fluid rounded" alt="">
					...
					<div class="col-lg-3 col-md-4 col-sm-12 text-center">
						<div class="comp-property">
							<a href="JavaScript:Void(0);">
								<div class="clp-img">
									<img src="assets/img/hotel/hotel-2.jpg" class="img-fluid rounded" alt="">
									<span class="remove-from-compare"><i class="fa-solid fa-xmark"></i></span>
								</div>
					...
					<div class="col-lg-3 col-md-4 col-sm-12 text-center pricing--emphasise">
						<div class="comp-property">
							<a href="JavaScript:Void(0);">
								<div class="clp-img">
									<img src="assets/img/hotel/hotel-3.jpg" class="img-fluid rounded" alt="">
									<span class="remove-from-compare"><i class="fa-solid fa-xmark"></i></span>
								</div>
					...
					<div class="col-lg-3 col-md-4 col-sm-12 text-center">
						<div class="comp-property">
							<a href="JavaScript:Void(0);">
								<div class="clp-img">
									<img src="assets/img/hotel/hotel-4.jpg" class="img-fluid rounded" alt="">
									<span class="remove-from-compare"><i class="fa-solid fa-xmark"></i></span>
								</div>
...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/compare-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:55 GMT -->
</html>