...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/contact-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:06 GMT -->
<head>
  <meta charset="utf-8">
				...
				<div class="row align-items-center justify-content-between g-4">
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card p-4 rounded-4 border br-dashed text-center mb-4">
							...
							<div class="crds-desc">
								<h5>Drop a Mail</h5>
								<p class="text-md lh-2 mb-0">Themezhub@gmail.com<br>Paythemezhub@gmail.com</p>
							</div>
						</div>
						...
						<div class="card p-4 rounded-4 border br-dashed text-center">
							...
							<div class="crds-desc">
								<h5>Call Us</h5>
								<p class="text-md lh-2 mb-0">(0522) 2563568<br>+91 256 6548 457</p>
							</div>
						</div>
					</div>
