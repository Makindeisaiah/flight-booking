...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:37 GMT -->
<head>
  <meta charset="utf-8">
							...
							<li>
								<div class="btn-group account-drop">
									...
									<div class="dropdown-menu pull-right animated flipInX">
										...
										<ul>
											<li><a href="my-profile.php"><i class="fa-regular fa-id-card me-2"></i>My Profile<span
														class="notti_coun style-1">4</span></a></li>
											<li><a href="my-booking.php"><i class="fa-solid fa-ticket me-2"></i>My Booking</a></li>
											<li><a href="travelers.php"><i class="fa-solid fa-user-group me-2"></i>Travelers</a></li>
											<li><a href="payment-detail.php"><i class="fa-solid fa-wallet me-2"></i>Payment Details</a></li>
											<li><a href="my-wishlists.php"><i class="fa-solid fa-shield-heart me-2"></i>My Wishlist</a></li>
											<li><a href="login.php"><i class="fa-solid fa-power-off me-2"></i>Sign Out</a></li>
										</ul>
									</div>
								</div>
							</li>
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12">
						<ul class="user-Dashboard-menu">
							<li><a href="my-profile.php"><i class="fa-regular fa-id-card me-2"></i>My Profile</a></li>
							<li><a href="my-booking.php"><i class="fa-solid fa-ticket me-2"></i>My Booking</a></li>
							<li><a href="travelers.php"><i class="fa-solid fa-user-group me-2"></i>Travelers</a></li>
							<li><a href="payment-detail.php"><i class="fa-solid fa-wallet me-2"></i>Payment Details</a></li>
							<li><a href="my-wishlists.php"><i class="fa-solid fa-shield-heart me-2"></i>My Wishlist</a></li>
							<li class="active"><a href="settings.php"><i class="fa-solid fa-sliders me-2"></i>Settings</a></li>
							<li><a href="delete-account.php"><i class="fa-solid fa-trash-can me-2"></i>Delete Profile</a></li>
							<li><a href="login.php"><i class="fa-solid fa-power-off me-2"></i>Sign Out</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
							...
							<div class="offcanvas-body p-0">
								<ul class="user-Dashboard-longmenu">
									<li><a href="my-profile.php"><i class="fa-regular fa-id-card me-2"></i>My Profile</a>
									</li>
									<li><a href="my-booking.php"><i class="fa-solid fa-ticket me-2"></i>My Booking</a>
									</li>
									<li><a href="travelers.php"><i class="fa-solid fa-user-group me-2"></i>Travelers</a></li>
									<li><a href="payment-detail.php"><i class="fa-solid fa-wallet me-2"></i>Payment Details</a></li>
									<li><a href="my-wishlists.php"><i class="fa-solid fa-shield-heart me-2"></i>My Wishlist</a></li>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card rounded-2 me-xl-5 mb-4">
							<div class="card-top bg-primary position-relative">
								<div class="position-absolute end-0 top-0 mt-4 me-3"><a href="login.php"
					...
					<div class="col-xl-8 col-lg-8 col-md-12">
						...
						<div class="card mb-4">
							<div class="card-header">
								<h4><i class="fa-regular fa-bell me-2"></i>Notification Settings</h4>
							</div>
							<div class="card-body">
								<div class="eportledd mb-4">
									<h6>Newsletter<span class="text-danger">*</span></h6>
									...
									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="" id="Event" checked>
										<label class="form-check-label" for="Event">
											New Event Created
										</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="" id="week" checked>
								...
								<div class="pushNotify d-flex align-items-start justify-content-between mb-3">
									<div class="pushNotify-flex">
										<p class="lh-2 fw-semibold text-dark mb-0">Mobile Push Notification</p>
										<span class="text-md text-muted-2">Receive push notification whenever your organization requires
											your attention</span>
									</div>
								...
								<div class="pushNotify d-flex align-items-start justify-content-between mb-3">
									<div class="pushNotify-flex">
										<p class="lh-2 fw-semibold text-dark mb-0">Desktop Notification</p>
										<span class="text-md text-muted-2">Receive Desktop notification whenever your organization requires
											your attention</span>
									</div>
									<div class="pushNotify-endflex">
										<div class="form-check form-switch">
								...
								<div class="pushNotify d-flex align-items-start justify-content-between mb-3">
									<div class="pushNotify-flex">
										...
										<span class="text-md text-muted-2">Receive email push notification whenever your organization
											requires your attention</span>
									</div>
									<div class="pushNotify-endflex">
										<div class="form-check form-switch">
											<input class="form-check-input" type="checkbox" role="switch" id="emailpush">
								...
								<div class="pushNotify d-flex align-items-start justify-content-between mb-3">
									<div class="pushNotify-flex">
										<p class="lh-2 fw-semibold text-dark mb-0">Show your profile publicly</p>
										<span class="text-md text-muted-2">Receive email push notification whenever your organization
											requires your attention</span>
									</div>
									<div class="pushNotify-endflex">
										<div class="form-check form-switch">
											<input class="form-check-input" type="checkbox" role="switch" id="publicaly" checked>
								...
								<div class="pushNotify d-flex align-items-start justify-content-between mb-3">
									<div class="pushNotify-flex">
										<p class="lh-2 fw-semibold text-dark mb-0">Check which device(s) access your account</p>
										<span class="text-md text-muted-2">Receive email push notification whenever your organization
											requires your attention</span>
									</div>
									<div class="pushNotify-endflex">
										<div class="form-check form-switch">
											<input class="form-check-input" type="checkbox" role="switch" id="eddred">
						...
						<div class="card mb-4">
							<div class="card-header">
								<h4><i class="fa-solid fa-gear me-2"></i>Security settings</h4>
							</div>
							<div class="card-body">
								<form class="mb-0">
