						...
						<ul class="nav-menu nav-menu-social align-to-right">
							<li class="currencyDropdown me-2">
								<a href="#" class="nav-link"><span
										class="fw-medium">USD</span></a>
							</li>
							<li class="languageDropdown me-2">
								<a href="#" class="nav-link"><img src="assets/img/flag/united-states.png" class="img-fluid" width="17" alt="Country"></a>
							</li>
							<li class="list-buttons light">
								<a href="register.php"><i class="fa-regular fa-circle-user fs-6 me-2"></i>Sign In / Register</a>
							</li>
						</ul>
					</div>
				</nav>
