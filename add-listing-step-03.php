...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/add-listing-step-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:41 GMT -->
<head>
  <meta charset="utf-8">
						...
						<div class="card mb-3">
							<div class="car-body px-xl-5 px-lg-4 py-lg-5 py-4">
								...
								<div class="d-flex align-items-center justify-content-center flex-column text-center mb-5">
									...
									<p class="text-md mb-0">Listing detail send to: <span
								...
								<div class="text-center d-flex align-items-center justify-content-center">
									<a href="#" class="btn btn-md btn-light-seegreen fw-semibold mx-2">Preview Your Listing</a>
									<a href="add-listing.php" class="btn btn-md btn-light-primary fw-semibold mx-2">Add New Listing</a>
								</div>
