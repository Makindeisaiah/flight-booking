...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-rental.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:09 GMT -->
<head>
  <meta charset="utf-8">
...
<body>
	...
	<div id="main-wrapper">
				...
				<nav id="navigation" class="navigation navigation-landscape">
					...
					<div class="nav-menus-wrapper" style="transition-property: none;">
						<ul class="nav-menu">
							...
							<li><a href="home-stay.php"><i class="fa-solid fa-umbrella-beach me-2"></i>Stays</a></li>
							...
							<li class="active"><a href="home-rental.php"><i
										class="fa-solid fa-house-circle-check me-2"></i>Rental</a></li>
		...
		<!-- ============================ Hero Banner  Start================================== -->
		<div class="image-cover hero-header bg-white" style="background:url(assets/img/banner.jpg)no-repeat;" data-overlay="5">
			<div class="container">
										...
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
											<div class="form-group mb-0">
												...
												<input type="text" class="form-control fw-bold" placeholder="Check-In & Check-Out"
													id="basicDate" readonly="readonly">
											</div>
										</div>
									</div>
								</div>
