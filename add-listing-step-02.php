...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/add-listing-step-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:33 GMT -->
<head>
  <meta charset="utf-8">
				...
				<div class="row align-items-start">
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="text-center d-flex align-items-center justify-content-center mt-4">
							<a href="add-listing.php" class="btn btn-md btn-dark fw-semibold me-2"><i
									class="fa-solid fa-arrow-left me-2"></i>Previous</a>
							<a href="add-listing-step-03.php" class="btn btn-md btn-primary fw-semibold ms-2">Submit<i
