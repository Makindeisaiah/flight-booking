...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:09 GMT -->
<head>
  <meta charset="utf-8">
...
<body>
	...
	<div id="main-wrapper">
				...
				<div class="row justify-content-between align-items-center">
					...
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
						<div class="position-relative mb-5">
							<div class="d-inline-flex align-items-center text-md text-muted-2 fw-semibold mb-2"><span class="square--30 circle bg-light-success text-success me-2"><i class="fa-regular fa-face-laugh-beam"></i></span>Hurry Up! 20% off on domestic flights</div>
							<h1 class="xl-heading">Book Your Next Tour with <span class="position-relative z-4">GeoTrip<span
						...
						<div class="position-relative search-wrap with-label mb-lg-0 mb-4">
							<div class="row align-items-center justify-content-between">
								<div class="col-xl-12 col-lg-12 col-12">
									<div class="form-group border rounded-1 mb-4">
										<label>Where</label>
								...
								<div class="col-xl-6 col-lg-6 col-12">
									<div class="form-group mb-4">
										...
										<input type="text" class="form-control choosedate fw-bold" placeholder="Check In" readonly="readonly">
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-12">
									<div class="form-group mb-4">
										<label>Choose Date</label>
										<input type="text" class="form-control choosedate fw-bold" placeholder="Check Out" readonly="readonly">
									</div>
								</div>
								<div class="col-xl-12 col-lg-12 col-12">
									<div class="form-group mb-4">
								...
								<div class="col-xl-12 col-lg-12 col-12">
									<button type="button" class="btn btn-light-primary full-width rounded-2 fw-medium">Check Availability<i class="fa-solid fa-arrow-right-long me-2"></i></button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
						<img src="assets/img/side-flip.png" class="img-fluid" alt="">
					</div>
				</div>
				<!-- </row> -->
						...
						<div class="main-carousel cols-4 dots-full">
							...
							<div class="carousel-cell">
								<div class="pop-touritem mb-4">
									<a href="flight-search.php" class="card rounded-3 shadow-wrap h-100 m-0">
		...
		<div class="position-relative py-5 bg-cover bg-primary" style="background:url(assets/img/bg.jpg)no-repeat;"
			data-overlay="5">
			<div class="container">
				<div class="row align-items-center justify-content-between">
					<div class="col-xl-12 col-lg-12 col-md-12">
...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:19 GMT -->
</html>