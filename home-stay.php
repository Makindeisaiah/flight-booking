...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-stay.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:06 GMT -->
<head>
  <meta charset="utf-8">
...
<body>
	...
	<div id="main-wrapper">
		...
		<!-- ============================ Hero Banner  Start================================== -->
		<div class="image-cover hero-header bg-white" style="background:url(assets/img/banner-8.jpg)no-repeat;" data-overlay="3">
			<div class="container">
							...
							<a href="flight-search.php" class="card rounded-3 border m-0">
								<div class="offers-container row align-items-center">
									<div class="offers-flex position-relative col-4">
										<div class="offers-pic p-2"><img src="assets/img/city/ct-3.png" class="img-fluid rounded" alt=""></div>
									</div>
							...
							<a href="flight-search.php" class="card rounded-3 border m-0">
								<div class="offers-container row align-items-center">
									...
									<div class="offers-captions col-8 ps-2">
										...
										<div class="booking-wrapes d-flex align-items-center justify-content-between">
											<p class="fs-5 low-price m-0"><span class="tag-span">Valid 31 July 2023</span></p>
										</div>
									</div>
								</div>
							</a>
		...
		<section class="py-5">
			<div class="container">
				...
				<div class="row justify-content-center gy-4 gx-3">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<a class="recommend-module-card" href="#">
							<div class="bokker-bg-full" style="background:url(assets/img/city/c-7.png)no-repeat;"></div>
...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-stay.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:09:09 GMT -->
</html>