...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:19 GMT -->
...
<body>
	...
	<div id="main-wrapper">
		...
		<!-- ============================ Hero Banner  Start================================== -->
		<div class="image-cover hero-header bg-white" style="background:url(assets/img/banner-4.jpg)no-repeat;" data-overlay="5">
			<div class="container">
										...
										<div class="row gy-3 gx-md-3 gx-sm-2">
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
												<div class="form-group border rounded-1 mb-0">
													<label>Where</label>
													<input class="form-control fw-bold" name="first_name">
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
												<div class="form-group mb-0">
													...
													<input type="text" name="last_name" class="form-control fw-bold" placeholder="Check-In & Check-Out" >
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-xl-8 col-lg-8 col-md-8 col-sm-7">
												<div class="form-group mb-0">
													...
													<div class="booking-form__input guests-input mixer-auto">
														<button id="guests-input-btn">1 Guest</button>
			...
			<div class="container">
				...
				<div class="row justify-content-center gy-4 gx-3">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="pop-touritem">
							<a href="flight-search.php" class="card rounded-3 h-100 m-0">
								<div class="flight-thumb-wrapper">
									<div class="popFlights-item-overHidden">
					...
					<div class="col-xl-5 col-lg-6 col-md-6">
						<div class="featuresList-box">
							...
							<div class="featuresList-single mb-4">
								<div class="featuresList-counter d-inline-block mb-3"><span class="bg-success text-light rounded-pill fw-medium py-1 px-3">01</span></div>
							...
							<div class="featuresList-single mb-4">
								<div class="featuresList-counter d-inline-block mb-3"><span class="bg-warning text-light rounded-pill fw-medium py-1 px-3">02</span></div>
								<div class="featuresList-caption">
							...
							<div class="featuresList-single mb-4">
								<div class="featuresList-counter d-inline-block mb-3"><span class="bg-purple text-light rounded-pill fw-medium py-1 px-3">03</span></div>
								<div class="featuresList-caption">
							...
							<div class="featuresList-single">
								<div class="featuresList-counter d-inline-block mb-3"><span class="bg-primary text-light rounded-pill fw-medium py-1 px-3">04</span></div>
								<div class="featuresList-caption">
...
<!-- Mirrored from shreethemes.net/geotrip-live/geotrip/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 16:08:27 GMT -->
